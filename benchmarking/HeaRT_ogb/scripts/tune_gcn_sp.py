...
def main():
    ...
    data_name = ['ogbl-ppa'] #'ogbl-ppa', 'ogbl-collab', 
    lr = ['0.001', '0.01']
    dropout = ['0.1', '0.3']
    split_type = ["SP_00_017_026",  "SP_00_026_036"] #"PA_034_026_00","PA_034_022_00", "PA_026_022_00"
        ...
        for l in lr:
            for d in dropout:
                for s in split_type:
                    ...
                    output_file = "output/z_GCN_" + full_data_name  + "_drp" + d + "_lr" + l + "_temp_heart_output.txt"
